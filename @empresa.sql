...
CREATE TABLE `personas` (
 ...
 );alter table personas add constraint unique key(cedula) ;

CREATE TABLE `tipos_empleados` (
  `id_tipo_empleado` int(11) NOT NULL AUTO_INCREMENT primary key,
  `tipo` varchar(20) DEFAULT NULL
 );alter table tipos_empleados add constraint unique key(tipo) ;
...
INSERT INTO tipos_empleados (tipo) VALUES ('OPERARIO');
INSERT INTO tipos_empleados (tipo) VALUES ('ADMINISTRATIVO');
INSERT INTO tipos_empleados (tipo) VALUES ('GERENTE');
INSERT INTO tipos_empleados (tipo) VALUES ('PRUEBA');
...
CREATE TABLE `tipos_articulo` (
  `id_tipo_articulo` int(11) NOT NULL AUTO_INCREMENT primary key,
  `tipo` varchar(20) DEFAULT NULL
 );alter table tipos_articulo add constraint unique key(tipo) ;
...
CREATE TABLE `articulos` (
  ...
  );alter table articulos add constraint unique key(codigo) ;
  
INSERT INTO tipos_articulo (tipo) VALUES ('BEBIDA');
INSERT INTO tipos_articulo (tipo) VALUES ('COMIDA');
INSERT INTO tipos_articulo (tipo) VALUES ('DULCE');
INSERT INTO tipos_articulo (tipo) VALUES ('PRUEBA1');
INSERT INTO tipos_articulo (tipo) VALUES ('PRUEBA2');
  
INSERT INTO `articulos` (`codigo`, `foto`, `descripcion`, `precio`, `fecha_fabricacion`) VALUES
(5422317, '', 'Bolsa para Lavar Ropa de 50x60cm con Cierre', 80, '31/01/20020'),
(5422318, '', 'Escurre Platos Metálico de 2 Niveles', 600, '12/03/20020'),
(5422319, '', 'Funda Protectora de Lavarropas Impermeable 58x62x85cm', 380, '11/02/20020'),
(5422320, '', 'Toallitas Quita Esmalte de Uñas Ideal para Cartera', 70, '15/02/20020'),
(5422321, '', 'Bolsa para Lavar Ropa de 50x60cm con Cierre', 80, '31/01/20020');